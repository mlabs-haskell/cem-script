  ...
  BuildTxWith $
    ScriptWitness scriptWitnessInCtx $
      mkScriptWitness
        script
        InlineScriptDatum
        (unsafeHashableScriptData $ fromPlutusData $ toData redeemer)

-- | Fields
txOutValue :: TxOut ctx Era -> Value
txOutValue (TxOut _ value _ _) = txOutValueToValue value

mTxOutDatum :: TxOut ctx Era -> Maybe _
